...
import { fetchSet, editSet } from '../../actions'
...
class EditSet extends React.Component {
  ...
  setTitle = (e, index) => {
    ...
    console.log(this.state.set.flashcards[index].title)
    console.log(addTitle)
  }
  setDescription = (e, index) => {
    var flash_cards = this.state.set.flashcards
    let addTitle = { ...flash_cards[index] }
    addTitle.description = e
    flash_cards[index] = addTitle
    this.setState({
      set: {
        ...this.state.set,
  ...
  submit = () => {
    ...
    if (check) {
      editSet(this.props.match.params.id, this.state.set)
        ...
        <Pane>
          ...
          <Pane width="50%" marginTop={20} marginBottom={20}>
            <TextInput
              ...
              label="PLEASE ENTER A TITLE TO EDIT YOUR SET"
              onFocus={(e) => {
                this.focus(e)
              }}
              onBlur={(e) => {
            ...
            >
              ...
              <Pane marginLeft="2%" width="47%">
                <TextInput
                  ...
                  onChange={(e) => {
                    this.setTitle(e.target.value, index)
                  }}
                  value={this.state.set.flashcards[index].title}
                ></TextInput>
              ...
              <Pane marginRight="2%" width="47%">
                <TextInput
                  ...
                  onChange={(e) => {
                    this.setDescription(e.target.value, index)
                  }}
                  value={this.state.set.flashcards[index].description}
                ></TextInput>
