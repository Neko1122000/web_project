...
import { fetchSetsUser, deleteSet } from '../../actions'
const heightItem = 75
const widthItem = 800
                          ...
                          >
                            <Link to={`/set/${item._id}`}>
                              <Pane width={(widthItem * 3) / 4}>
                                ...
                                <br />
                                <Text>{item.number_flash_card + ' terms'}</Text>
                              </Pane>
                            </Link>
                            <Pane
                              display="flex"
                              ...
                              paddingRight={20}
                            >
                              <Link to={`edit-set/${item._id}`}>
                                <Pane>
                                  <Tooltip content="Edit this folder">
                                    <EditIcon color="#1070CA" size={20} />
                                  </Tooltip>
                                </Pane>
                              </Link>
                              <Pane
                                onClick={() => {
                                  this.isRemoveSet(item._id)
                                }}
                              >
